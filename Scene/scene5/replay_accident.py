...
def main():
    try:
        ...
        argparser.add_argument('--vehicle-trace', type=str, help='车辆轨迹CSV文件',default="sumo_data/vehicle_trace_20250808-140546.csv")
        argparser.add_argument('--collision-trace', type=str, help='事故记录CSV文件',default="sumo_data/collisions_20250808-140546.csv")
        argparser.add_argument('--sumo-config', type=str, help='SUMO配置文件路径', default="simulation.sumocfg")
        argparser.add_argument('--collisions_number', type=int, help='发生的碰撞事故', default="2")

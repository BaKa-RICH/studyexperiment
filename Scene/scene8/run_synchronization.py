...
class SimulationSynchronization(object):
    ...
    def __init__(self,
        ...
        # Mapped actor ids.
        self.sumo2carla_ids_inv = {}
        self.carla2sumo_ids_inv ={}
    ...
    def tick(self):
        ...
        # -----------------
        # sumo-->carla sync
        success = self.sumo.tick()  # ✅ 注意 sumo.tick() 自己已经 return True/False 了
        if not success:
            print("[Error] sumo.tick() failed.")
            return False
        # -----------------
        ...
        for sumo_actor_id in sumo_spawned_actors:
            ...
            # 传递 sumo_actor_id 用于检查特定 ID
            carla_blueprint = BridgeHelper.get_carla_blueprint(sumo_actor, self.sync_vehicle_color, sumo_actor_id)
        ...
        self.sumo2carla_ids_inv = {v: k for k, v in self.sumo2carla_ids.items()}

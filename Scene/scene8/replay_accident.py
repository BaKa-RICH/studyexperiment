        ...
        for vehicle_id, trajectory in vehicle_data.items():
            ...
            if step_count >= 2:
                ...
                if carla_vehicle:
                    ...
                    offset = carla.Location(z=45)
                    spectator = world.get_spectator()
                    spectator.set_transform(carla.Transform(location + offset, carla.Rotation(pitch=-90, yaw=-100)))
...
def main():
    try:
        ...
        argparser.add_argument('--vehicle-trace', type=str, help='车辆轨迹CSV文件',default="sumo_data/vehicle_trace_20250822-133103.csv")
        argparser.add_argument('--collision-trace', type=str, help='事故记录CSV文件',default="sumo_data/collisions_20250822-133103.csv")

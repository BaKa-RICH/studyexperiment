...
def main():
    try:
        ...
        argparser.add_argument('--sumo_cfg_file', type=str, help='sumo configuration file', default="scene4_replay_accident_rou/scene4.sumocfg")
        ...
        argparser.add_argument('--vehicle-trace', type=str, help='车辆轨迹CSV文件',default="sumo_data/vehicle_trace_20251207-224554.csv")
        argparser.add_argument('--collision-trace', type=str, help='事故记录CSV文件',default="sumo_data/collisions_20251207-224554.csv")
